...
- Improved Shelf recording permission timing.
- Added blue frosted-glass onboarding visuals.
- Improved menu bar icon scanning and fallback icons.

## 1.0.2

- Published Sparkle appcast release assets.
- Fixed collapsed restore status item behavior.
- Improved restore icon alignment after wake.

## 1.0.1

- Avoided eager Screen Recording prompts.
- Started core services once Accessibility is available.
- Updated permission onboarding copy.
